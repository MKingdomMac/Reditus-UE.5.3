...
void UPixel2DAnimStateMachineSchema::GetGraphContextActions(FGraphContextMenuBuilder& ContextMenuBuilder) const
{
	...
	// Add conduit node
	{
		TSharedPtr<FPixel2DGraphSchemaAction_NewStateNode> Action = AddNewStateNodeAction(ContextMenuBuilder, FText::GetEmpty(), LOCTEXT("AddConduit", "Add Conduit..."), LOCTEXT("AddConduitTooltip", "A new conduit state"));
		Action->NodeTemplate = NewObject<UPixel2DAnimStateConduitNode>(ContextMenuBuilder.OwnerOfTemporaries);
	}
