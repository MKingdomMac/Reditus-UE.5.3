...
class FPixel2DEditorViewportClient : public FEditorViewportClient
{
public:
	/** Constructor */
	explicit FPixel2DEditorViewportClient(const TWeakPtr<class SEditorViewport>& InEditorViewportWidget = nullptr);
	~FPixel2DEditorViewportClient();
