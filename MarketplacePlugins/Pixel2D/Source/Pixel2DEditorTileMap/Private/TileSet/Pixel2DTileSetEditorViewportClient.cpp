...
FPixel2DTileSetEditorViewportClient::FPixel2DTileSetEditorViewportClient(UPaperTileSet* InTileSet)
...
void FPixel2DTileSetEditorViewportClient::Draw(FViewport* InViewport, FCanvas* Canvas)
{
	// Clear the viewport
...
FLinearColor FPixel2DTileSetEditorViewportClient::GetBackgroundColor() const
{
...
void FPixel2DTileSetEditorViewportClient::ToggleShowTilesWithCollision()
{
	bShowTilesWithCollision = !bShowTilesWithCollision;
	bShowTilesWithMetaData = false;
}

bool FPixel2DTileSetEditorViewportClient::IsShowTilesWithCollisionChecked() const
{
	return bShowTilesWithCollision;
}

void FPixel2DTileSetEditorViewportClient::ToggleShowTilesWithMetaData()
{
	bShowTilesWithMetaData = !bShowTilesWithMetaData;
	bShowTilesWithCollision = false;
}

bool FPixel2DTileSetEditorViewportClient::IsShowTilesWithMetaDataChecked() const
{
