...
FPixel2DTileMapRenderSceneProxy::FPixel2DTileMapRenderSceneProxy(const UPixel2DTileMapComponent* InComponent)
...
#endif
	, TileMap(InComponent->GetTileMap())
	, OnlyLayerIndex(INDEX_NONE)//InComponent->GetUseSingleLayerIndex())
...
SIZE_T FPixel2DTileMapRenderSceneProxy::GetTypeHash() const
{
	static size_t UniquePointer;
	return reinterpret_cast<size_t>(&UniquePointer);
}

FPixel2DTileMapRenderSceneProxy* FPixel2DTileMapRenderSceneProxy::CreateTileMapProxy(const UPixel2DTileMapComponent* InComponent, TArray<FSpriteRenderSection>*& OutSections, TArray<FDynamicMeshVertex>*& OutVertices)
{
	FPixel2DTileMapRenderSceneProxy* NewProxy = new FPixel2DTileMapRenderSceneProxy(InComponent);
...
void FPixel2DTileMapRenderSceneProxy::FinishConstruction_GameThread()
{
}

void FPixel2DTileMapRenderSceneProxy::DrawBoundsForLayer(FPrimitiveDrawInterface* PDI, const FLinearColor& Color, int32 LayerIndex) const
{
...
void FPixel2DTileMapRenderSceneProxy::DrawNormalGridLines(FPrimitiveDrawInterface* PDI, const FLinearColor& PerTileColor, const FLinearColor& MultiTileColor, int32 MultiTileGridWidth, int32 MultiTileGridHeight, int32 MultiTileGridOffsetX, int32 MultiTileGridOffsetY, int32 LayerIndex) const
{
...
void FPixel2DTileMapRenderSceneProxy::DrawStaggeredGridLines(FPrimitiveDrawInterface* PDI, const FLinearColor& PerTileColor, const FLinearColor& MultiTileColor, int32 MultiTileGridWidth, int32 MultiTileGridHeight, int32 MultiTileGridOffsetX, int32 MultiTileGridOffsetY, int32 LayerIndex) const
{
	FLinearColor Color = PerTileColor;
	TArray<FVector> Poly;
	Poly.Empty(4);
...
void FPixel2DTileMapRenderSceneProxy::DrawHexagonalGridLines(FPrimitiveDrawInterface* PDI, const FLinearColor& PerTileColor, const FLinearColor& MultiTileColor, int32 MultiTileGridWidth, int32 MultiTileGridHeight, int32 MultiTileGridOffsetX, int32 MultiTileGridOffsetY, int32 LayerIndex) const
{
...
void FPixel2DTileMapRenderSceneProxy::GetDynamicMeshElements(const TArray<const FSceneView*>& Views, const FSceneViewFamily& ViewFamily, uint32 VisibilityMap, FMeshElementCollector& Collector) const
{
