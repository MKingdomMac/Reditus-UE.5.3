...
//////////////////////////////////////////////////////////////////////////
// FPixel2DAnimAssetViewportClient
class FPixel2DAnimAssetViewportClient : public FEditorViewportClient
{
public:
	FPixel2DAnimAssetViewportClient(FPreviewScene& InPreviewScene);
...
protected:
	...
	*/
	 ...
	 */
	TSharedPtr<FPixel2DAnimAssetViewportClient> ViewportClient;

	/**
	 * Skeletal component to preview the animation asset on
	 */
	UPaperFlipbookComponent* PreviewComponent;
