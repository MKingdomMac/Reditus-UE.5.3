...
void SPixel2DGraphNodeConduit::Construct(const FArguments& InArgs, UPixel2DAnimStateConduitNode* InNode)
{
	SPixel2DGraphNodeState::Construct(SPixel2DGraphNodeState::FArguments(), InNode);
}
