...
bool FPixel2DAnimBlueprintEditor::IsEditable(UEdGraph* InGraph) const
{
...
FGraphAppearanceInfo FPixel2DAnimBlueprintEditor::GetGraphAppearance(UEdGraph* InGraph) const
{
	FGraphAppearanceInfo AppearanceInfo = FBlueprintEditor::GetGraphAppearance(InGraph);

	if (GetBlueprintObj()->IsA(UPixel2DAnimBlueprint::StaticClass()))
	{
...
void FPixel2DAnimBlueprintEditor::OnCreateGraphEditorCommands(TSharedPtr<FUICommandList> GraphEditorCommandsList)
{
	GraphEditorCommandsList->MapAction(FPixel2DAnimGraphCommands::Get().OpenRelatedAsset,
		FExecuteAction::CreateSP(this, &FPixel2DAnimBlueprintEditor::OnOpenRelatedAsset)
	);
}
