		...
		SNew(SOverlay)
			...
			*/
			...
			[
				...
				.OnTextCommitted(this, &SDialogueNodeWidget::TextCommitted, Id)
...
void SDialogueNodeWidget::TextCommitted(const FText& NewText, ETextCommit::Type CommitInfo, int32 id)
{
	...
	Owner->DialogueEditorPtr.Pin()->GetDialogueBeingEdited()->bRefreshDetails = true;
}
