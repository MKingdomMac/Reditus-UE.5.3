...
public:
	...
	{
		FPixel2DAnimGraphCommands::Register();
...
private:
	...
	void OnNewBlueprintCreated(UBlueprint* InBlueprint)
	{
		if (ensure(InBlueprint->UbergraphPages.Num() > 0))
		{
			...
			FKismetEditorUtilities::AddDefaultEventNode(InBlueprint, InBlueprint->UbergraphPages[0], FName("BlueprintUpdateAnimation"), UPixel2DAnimInstance::StaticClass(), NodePositionY);
		}
	}
};
