...
void SPixel2DGraphNode::Construct(const FArguments& InArgs, UPixel2DAnimGraphNode_Base* InNode)
{
...
TArray<FOverlayWidgetInfo> SPixel2DGraphNode::GetOverlayWidgets(bool bSelected, const FVector2D& WidgetSize) const
{
